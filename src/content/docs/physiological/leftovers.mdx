...
Every leftover you create should be cataloged somewhere that allows you to easily slot them into your meal planning calendar. This is why I suggest Todoist. In Todoist's calendar view any list item that is not assigned a date can be displayed in a sidebar. This is your leftovers cache. You can then simply drag and drop a meal onto the day you plan to eat it. Ideally you will have enough variety in your leftovers that every day of the week can be a different meal. Eating a meal more than once per week is a surefire way to burn out on your own cooking.

<Image src={todoistImg} alt="Todoist calendar with meal plan" />

As your leftovers cache builds up, you will likely need more freezer safe containers. I recommend investing in glass containers so that you can thaw and place your leftovers directly in the oven for reheating. The best food storage container I've found yet are Pyrex Ultimate because both the container and lid are freezer, dishwasher, and oven safe.
